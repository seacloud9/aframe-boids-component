	  ...
	  init: function () {
	    ...
	    var Bird = __webpack_require__(2);
	      ...
	      for ( var i = 0; i < 200; i ++ ) {
	          ...
	          this.data.bird = this.data.birds[ i ] = new THREE.Mesh( new Bird(), new THREE.MeshBasicMaterial( { color:Math.random() * 0xffffff, side: THREE.DoubleSide } ) );
